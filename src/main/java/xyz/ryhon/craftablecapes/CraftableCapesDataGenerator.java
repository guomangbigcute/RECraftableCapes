		...
		protected RecipeGenerator getRecipeGenerator(WrapperLookup registryLookup, RecipeExporter exporter) {
			return new RecipeGenerator(registryLookup, exporter) {
				...
				public void generate() {
					...
					// New capes added in 2026
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_ZOMBIE_HORSE)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_CRAFTER)
							.input('O', Items.ORANGE_WOOL)
							.input('B', Items.BROWN_WOOL)
							.input('W', Items.WHITE_WOOL)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_BUILDER)
							.input('O', Items.ORANGE_WOOL)
							.input('B', Items.BROWN_WOOL)
							.input('W', Items.WHITE_WOOL)
							.input('I', Items.CRAFTING_TABLE)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MOONLIGHT_TRAIL)
							.input('B', Items.BLUE_WOOL)
							.input('W', Items.WHITE_WOOL)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_4J_STUDIO)
							.input('R', Items.RED_WOOL)
							.input('W', Items.WHITE_WOOL)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_DOCUMENT)
					...
					// MINECON Unused Capes (6-16) - Different colored wool recipes
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_6)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_7)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_8)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_9)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_10)
							.input('W', Items.RED_WOOL)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_11)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_12)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_13)
							.input('W', Items.RED_WOOL)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_14)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_15)
					...
					createShaped(RecipeCategory.DECORATIONS, CraftableCapes.CAPE_MINECON_16)
							.input('W', Items.RED_WOOL)
							.input('Y', Items.YELLOW_WOOL)
							.pattern("YYY")
							.pattern("WWW")
